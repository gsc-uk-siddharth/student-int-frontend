    ...
    <>
      <section className="bg-white mt-20 dark:bg-gray-900">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          <h2 className="mb-4 text-4xl underline tracking-tight font-extrabold text-center text-gray-900 dark:text-white">
            Apply Now!
          </h2>
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            ...
            <Link
              classname="text-primary-600 text-light"
              href={"mailto:studyabroad@studentint.com"}
            >
