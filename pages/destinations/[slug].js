    ...
    <>
      <div className="pt-20 mt-5">
        <Image
          ...
          alt=""
        />
        <div className="text-justify py-4 lg:pl-20 lg:ml-20 lg:px-20 lg:mx-20 underline pl-2 text-4xl font-bold">
          {destination.name}
        </div>
        <PortableText
          ...
          serializers={{
            ...
            ul: ({ children }) => (
              <ul className=" list-disc ml-2 pl-2 px-2 lg:pl-20 lg:ml-20  flex justify-start items-start py-4 flex-col">
                {children}
              </ul>
            ),
            li: ({ children }) => (
            ...
            normal: ({ children }) => (
              <p className="text-xl  px-2 py-2 lg:pl-20 lg:ml-20 lg:px-20 lg:mx-20 text-justify  justify-center">
                {children}
              </p>
            ),
            marks: ({ children }) => (
